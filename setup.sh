...
# ===============================
# STEP 7 — Git Reset & Checkout Version
# ===============================
echo ""
...
echo ""
echo "1️⃣  Create a new screen session:"
echo "    screen -S gensyn"
echo ""
echo "2️⃣  Go to the project directory:"
echo "    cd rl-swarm"
echo ""
